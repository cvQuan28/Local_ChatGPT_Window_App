...
class MainWindow(QMainWindow):
    ...
    def get_response(self):
        ...
        if message_input:
            response_str = open_ai_chat.get_response(message_input)
            # response_list = [{"input_str": "how are you?", "out_str": "I'm doing well, thanks! How are you?"}, {"input_str": "how old are you?", "out_str": "I am 28 years old."}]
            # # response_str = "\n".join(response_list)
