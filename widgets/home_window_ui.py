...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("static/icons/brightness-high.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"padding: 10px;")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("static/icons/lightning-charge.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"padding: 10px;")
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("static/icons/exclamation-triangle.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
